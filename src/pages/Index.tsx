...
const Index = () => {
  ...
  <Button onClick={() => setShowVoiceRecorder(true)} className="...">
    <Mic className="w-6 h-6 mr-2" />
    Anotação por voz 🎤
  </Button>

  <Button onClick={() => setShowFixedExpensesModal(true)} className="...">
    <span role="img" aria-label="gastos fixos">💳</span>
    Gastos Fixos
  </Button>

  <Button onClick={() => setShowExpenseForm(true)} className="...">
    <Plus className="w-6 h-6 mr-2" />
    Novo Gasto 💸
  </Button>

  <Button onClick={() => setShowGoalForm(true)} className="...">
    <Target className="w-6 h-6 mr-2" />
    Nova Meta 🎯
  </Button>

  <Button onClick={() => setShowBudgetForm(true)} className="...">
